...
export function generateDBML(
    ...
    for (const relation of relations) {
        ...
        const sourceField = sourceTable.fields.find(
            (f) => f.id == relation.sourceFieldId
        )!;
        const targetField = targetTable.fields.find(
            (f) => f.id == relation.targetFieldId
        )!;
...
export function parseCode(
    ...
    while ((tableMatch = tableRegex.exec(code)) !== null) {
        ...
        while ((fieldMatch = fieldRegex.exec(fieldsBlock)) !== null) {
            ...
            const primaryKey =
                /\[primary key\]/i.test(modifiers) || /\[pk\]/i.test(modifiers);
...
export function getRelationshipContentHash(
